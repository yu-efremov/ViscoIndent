# -*- coding: utf-8 -*-
"""
gui for viscoindent, v. 21-May-2020
...
class App(QMainWindow):
    ...
    def read_data(self):
        ...
        # tSize = QTableWidgetDisabledItem(self.table3)
        # self.table3.setColumnReadOnly(0,True)
        # self.delegate = QtGui.QStyledItemDelegate()
        # self.table3.setItemDelegateForColumn(4, self.delegate)
    ...
    def initUI(self):
        ...
        ViscoPars['visco-par2'] = 0.2  # Pars['Vpars'][1]
        ViscoPars['visco-par3'] = 0  # Pars['Vpars'][2]
        ViscoPars['visco-par4'] = 0  # Pars['Vpars'][3]
        ViscoPars['visco-par5'] = 0  # Pars['Vpars'][3]
