...
def tingFC_constructor(Pars, indentationfull):
    ...
    [force, cradius, contact_time, t1_ndx2, Et] = ting_numerical(pars,
        Poisson, probe_dim, dT, MaxInd, Height, modelting, modelprobe, indentationfull)[0:5]
...
if __name__ == '__main__':
    ...
    Pars['height'] = 0
    Pars['indpars'] = np.array([1, 50, 50, 500, 0]) # [yes/no; depth; speed; numpoimts; ramp/sin];
    
    Pars['viscomodel'] = 'sPLR'
    Pars['Vpars'] = np.array([1000, 0.4, 0, 0])
