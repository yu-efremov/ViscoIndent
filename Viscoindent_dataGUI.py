...
class App(QMainWindow):
    ...
    def button_save_excel_click(self):
        filename = QFileDialog.getSaveFileName(self, 'Save File', "Results.xlsx",'Excel files(.xlsx);;All files()')[0]
    ...
    def curveviewer(self):
        ...
        if len(self.Data)==1:
            ...
            button_update = QPushButton('Update graph', self)
            button_update.setToolTip('Update graph')
            button_update.clicked.connect(self.changeValue)
        else:
